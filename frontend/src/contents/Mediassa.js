        ...
        return (
            <div className="maincontent__container">
                ...
                <ul>
                    ...
                    <li>
                        <a target="_blank" href="">Kirjasta kirjaan -blogi</a>, Hannele Salminen, 26.11.2017
                    </li>
                    <li>
                        <a target="_blank" href="">Yle Puheen Nosto -ohjelma</a>,  17.10.2017, toimittajat Linda Vettanen ja Miia Krause
                    </li>
                </ul>
